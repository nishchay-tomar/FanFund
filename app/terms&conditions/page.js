  ...
  return (
    <div className="bg-black text-white py-8 px-4 sm:px-6 lg:px-8">
      <div className="max-w-3xl mx-auto">
        ...
        <p className="text-gray-300 mb-6">
          Welcome to FanFund. By using our website, you agree to comply with and be bound by the following terms and conditions:
        </p>
        ...
        <p className="text-gray-300 mb-6">
          <strong>Intellectual Property:</strong> All content on this site is the property of FanFund or its content suppliers and protected by intellectual property laws.
        </p>
        <p className="text-gray-300 mb-6">
