      ...
      <div className="bg-black">
        ...
        >
          <div className="mx-[-10px] md:px-10 my-5 ">
            ...
            &quot;Fueling Creativity, One Step at a Time!&quot;
            </div>
            <p className="p-4 text-gray-200 text-md text-center font-sans">
              At FanFund, we are committed to fostering a vibrant
            ...
            <p className="p-4 text-gray-200 text-md text-center font-sans">
              ...
              an influencer sharing your unique perspective with the world, 
              FanFund is here to support you every step of the way.
            </p>
            <p className="p-4 text-gray-200 text-md text-center font-sans">
            ...
            <p className="p-4 text-gray-200 text-md text-center font-sans">
              At FanFund, we take pride in helping creators reach their
              ...
              developers, creators, and influencers. 
            </p>
          </div>
          ...
          <div className="relative mx-auto max-w-5xl text-center">
            ...
            <p className="mx-auto my-4 w-full max-w-xl bg-transparent text-center font-medium leading-relaxed tracking-wide text-gray-400">
              At FanFund, we empower developers, creators, and influencers
