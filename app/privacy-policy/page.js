  ...
  return (
    <div className="bg-black py-8 px-4 sm:px-6 lg:px-8">
      <div className="max-w-3xl mx-auto">
        ...
        <p className="text-gray-200 mb-6">
          At FanFund, we are committed to protecting your privacy. This Privacy Policy outlines how we collect, use, and safeguard your information.
        </p>
        ...
        <p className="text-gray-200 mb-6">
          <strong>Your Rights:</strong> You have the right to access, update, and delete your personal information. To exercise these rights, please contact us at <a href="mailto:support@FanFund.com" className="text-blue-500 hover:underline">support@FanFund.com</a>.
        </p>
